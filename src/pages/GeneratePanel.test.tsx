...
vi.mock('@/components/generate/ImageDropZone', () => ({
  ImageDropZone: () => <div>Reference Drop Zone</div>,
}));
...
describe('GeneratePanel', () => {
  ...
  it('persists collapsed reference inputs across remounts', () => {
    ...
    expect(screen.getByText('Reference Drop Zone')).toBeInTheDocument();

    fireEvent.click(screen.getByTestId('toggle-generate-section-reference-inputs'));

    expect(screen.queryByText('Reference Drop Zone')).not.toBeInTheDocument();
