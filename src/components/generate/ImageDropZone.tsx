...
export function ImageDropZone({
  ...
  return (
    <div className="rounded-lg border border-border bg-elevated/50 overflow-hidden">
      ...
      >
        <Upload className="w-3.5 h-3.5 text-red-primary" />
            ...
            {referenceImage ? (
                    ...
                    {modes.map((m) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            'flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-display font-medium transition-all',
                            mode === m.id
              ...
              >
                <Upload
                  className={cn(
                    'w-6 h-6 mb-2',
                    isDragOver ? 'text-red-primary' : 'text-text-muted'
                  )}
                />
                <p className="text-sm font-display text-text-body">
